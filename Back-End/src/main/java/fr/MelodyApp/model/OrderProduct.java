...
public class OrderProduct {
    ...
    @Column(name="PRICE_TOTAL", nullable = false) private int priceTotal;
	...
	public OrderProduct(Order order, Product product,Integer user, Integer quantity, int priceTotal) {
